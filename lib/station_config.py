...
1 = Fine X || mobiis:m1  || mobiis:m1.RBV
2 = Fine Y || mobiis:m2  || mobiis:m2.RBV
3 = Energy || mobiis:m4  || mobiis:m4.RBV
4 = Theta  || mobiis:m3  || mobiis:m3.RBV
5 = Focus Z || mobiis:m5 || mobiis:m5.RBV
6 = Coarse X || mobiis:m7 || mobiis:m7.RBV
7 = Coarse Y || mobiis:m6 || mobiis:m6.RBV
#--------------------------#
[xafs]
energy_drive = mobiis:m4.VAL
energy_read  = mobiis:m4.RBV
#--------------------------#
[slewscan]
type = NewportXPS
mode = PVTGroup
...
1 = scaler1     || HFXAFS:scaler1 || kind=scaler, nchan=8, use_calc=True
2 = me4         || 13SDD1:        || kind=multimca, nmcas=4, nrois=32, use_net=False, use_full=False
#--------------------------#
[counters]
# index = label || PVname
1 = MotorX_Steps  || mobiis:m7.RRBV
#--------------------------#
[extrapvs]
# index = label || PVname
1 = Ring Current || G:BEAMCURRENT.VAL
